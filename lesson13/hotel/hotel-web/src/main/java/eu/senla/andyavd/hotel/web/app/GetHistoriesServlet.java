...
public class GetHistoriesServlet extends HttpServlet {

	private static final long serialVersionUID = -4243592806085436141L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<RoomHistory> histories = hotelManager.getHistories();
		writer.write(mapper.writeValueAsString(histories));
		request.getSession().setAttribute("method","GET");
	}

	public GetHistoriesServlet() {
		super();
	}
}
