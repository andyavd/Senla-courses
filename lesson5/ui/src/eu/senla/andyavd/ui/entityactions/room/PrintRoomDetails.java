...
public class PrintRoomDetails implements IAction {
	...
	public void execute() {
		...
		Printer.print(HotelManager.getInstance().getRoomDetails(HotelManager.getInstance().getRoomById(id)).toString());
