package eu.senla.andyavd.utils.csv;
...
import eu.senla.andyavd.property.Settings;
					...
					for (AEntity entity : entities) {
						for (Field field : fields) {
							if (field.isAnnotationPresent(CsvProperty.class)) {
								...
								if (field.getAnnotation(CsvProperty.class)
										.propertyType() == PropertyType.CompositeProperty) {
									sortedFields.put(field.getAnnotation(CsvProperty.class).columnNumber(),
											CommonCSVConvertor.convertEntityToString(field.get(entity),
													field.getAnnotation(CsvProperty.class).keyField()));
								} else {
									sortedFields.put(field.getAnnotation(CsvProperty.class).columnNumber(),
