package eu.senla.andyavd.hotelui.ui.actions.sorters.service;
...
public class ByName implements IAction {
	...
	private final static Logger logger = Logger.getLogger(ByName.class);
	...
	public void execute(TransactionWorker serverWorker) {
		...
		try {
			...
			Request request = new Request("sortServicesByName", null);
