...
import eu.senla.andyavd.hotelui.ui.actions.room.*;
import eu.senla.andyavd.hotelui.ui.actions.service.*;
import eu.senla.andyavd.hotelui.ui.actions.sorters.room.*;
import eu.senla.andyavd.hotelui.ui.actions.sorters.service.*;
import eu.senla.andyavd.hotelui.ui.actions.sorters.visitor.*;
import eu.senla.andyavd.hotelui.ui.actions.visitor.*;
import eu.senla.andyavd.hotel.utils.client.enums.MenuTypes;
...
public class Builder {
	...
	public Menu buildMenu() {
		...
		roomMenu.addMenuItem(
				new MenuItem("Print the quantity of the empty Rooms", roomMenu, new PrintEmptyNumberAction()));
		...
		roomMenu.addMenuItem(
				new MenuItem("Print the last visitors of the Room", roomMenu, new PrintLastVisitorsAction()));
		...
		serviceMenu.addMenuItem(
				new MenuItem("Export Services information to file", serviceMenu, new ExportServicesAction()));
		serviceMenu.addMenuItem(
				new MenuItem("Import Services information from file", serviceMenu, new ImportServicesAction()));
		...
		visitorMenu.addMenuItem(
				new MenuItem("Print the quantity of the Visitors on a date", visitorMenu, new PrintOnDateAction()));
		...
		visitorMenu
				.addMenuItem(new MenuItem("Sort the Visitor's Services by price", visitorMenu, new ServicesByPrice()));
		visitorMenu.addMenuItem(
				new MenuItem("Export Visitors information to file", visitorMenu, new ExportVisitorsAction()));
		visitorMenu.addMenuItem(
				new MenuItem("Import Visitors information from file", visitorMenu, new ImportVisitorsAction()));
